...
--
-- Changes:
--   1. Recreate v_pending_payment_validations view WITHOUT lock columns
--   2. Drop the lock-related columns from service_payments
--   3. Drop the lock index
--
-- Columns dropped:
...
-- ============================================================================
-- 2. RECREATE VIEW: v_pending_payment_validations (without lock columns)
-- ============================================================================
...
-- ============================================================================
-- 3. DROP INDEX on lock column
-- ============================================================================
DROP INDEX IF EXISTS idx_service_payments_locked_profile;

-- ============================================================================
-- 4. DROP COLUMNS from service_payments
-- ============================================================================
...
-- ============================================================================
-- 5. Also drop legacy lock column if it exists
-- ============================================================================
