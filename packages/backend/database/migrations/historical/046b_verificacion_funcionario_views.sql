-- Migration 046b: Create views and functions for verificacion_funcionario
-- Prerequisite: Execute 046a first

-- 1. Drop existing views
DROP VIEW IF EXISTS v_verificaciones_pendientes CASCADE;
DROP VIEW IF EXISTS v_verificacion_stats CASCADE;

-- 2. Create pending verifications view
...
SELECT
    ...
    COALESCE(
        ...
        vf.verification_data->'dip'->'extraction'->'titular'->>'nombres',
...
-- 5. Create batch approval function
