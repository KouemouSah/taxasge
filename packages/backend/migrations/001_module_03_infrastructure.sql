...
ALTER TABLE sessions
  ...
  ALTER COLUMN ip_address TYPE INET USING
    CASE
      ...
      WHEN ip_address ~ '^[0-9]+\.[0-9]+\.[0-9]+\.[0-9]+$' THEN ip_address::INET
...
BEGIN
    ...
    RAISE NOTICE '✅ Test 1 passed: sessions table extended successfully';
END $$;
...
BEGIN
    ...
    RAISE NOTICE '✅ Test 2 passed: agent_work_queue table created successfully';
END $$;
...
BEGIN
    ...
    RAISE NOTICE '✅ Test 3 passed: document_processing_queue table created successfully';
END $$;
...
BEGIN
    ...
    RAISE NOTICE '✅ Test 4 passed: All triggers created successfully';
END $$;
...
BEGIN
    ...
    📊 SUMMARY:
    - ✅ Table sessions: 2 columns added (context_data, termination_reason)
    - ✅ Table agent_work_queue: Created with 3 triggers
    - ✅ Table document_processing_queue: Created with 3 triggers
    - ✅ 8 indexes created for performance
    - ✅ 6 functions created (priority calc, SLA tracking, retry logic)
