...
5. payment_lock_history (historique verrouillage)
6. payment_validation_audit (audit trail validation)
7. service_payments (workflow agents avec verrouillage pessimiste)
...
- service_payments.assigned_agent_id → ministry_agents
...
- Agent workflow (lock, validate, escalate)
