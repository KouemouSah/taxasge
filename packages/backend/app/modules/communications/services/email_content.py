...
EMAIL_CONTENT: Dict[str, Dict[str, Dict[str, str]]] = {
    ...
    "agent_invitation": {
        "es": {
            "subject": "TaxasGE - Invitación para ser Agente",
            "title": "Invitación para ser Agente TaxasGE",
            "greeting": "Hola {user_name},",
            "greeting_default": "Hola,",
            "message": "Has sido invitado/a a unirte a la plataforma TaxasGE como Agente. Para completar tu registro, utiliza el siguiente código de verificación:",
        ...
        "fr": {
            "subject": "TaxasGE - Invitation Agent",
            "title": "Invitation Agent TaxasGE",
            "greeting": "Bonjour {user_name},",
            "greeting_default": "Bonjour,",
            "message": "Vous avez été invité(e) à rejoindre la plateforme TaxasGE en tant qu'Agent. Pour compléter votre inscription, utilisez le code de vérification suivant :",
        ...
        "en": {
            "subject": "TaxasGE - Agent Invitation",
            "title": "TaxasGE Agent Invitation",
            "greeting": "Hello {user_name},",
            "greeting_default": "Hello,",
            "message": "You have been invited to join the TaxasGE platform as an Agent. To complete your registration, use the following verification code:",
    ...
    "admin_invitation": {
        "es": {
            "subject": "TaxasGE - Invitación para ser Administrador",
            "title": "Invitación para ser Administrador TaxasGE",
            "greeting": "Hola {user_name},",
            "greeting_default": "Hola,",
            "message": "Has sido invitado/a a unirte a la plataforma TaxasGE como Administrador. Para completar tu registro, utiliza el siguiente código de verificación:",
            "instructions": "Haz clic en el botón de abajo para activar tu cuenta y establecer tu contraseña.",
            "button_text": "Activar mi cuenta",
            "or_copy_text": "O copia y pega este enlace en tu navegador:",
            "expiry_label": "Este código expirará en:",
        ...
        "fr": {
            "subject": "TaxasGE - Invitation Administrateur",
            "title": "Invitation Administrateur TaxasGE",
            "greeting": "Bonjour {user_name},",
            "greeting_default": "Bonjour,",
            "message": "Vous avez été invité(e) à rejoindre la plateforme TaxasGE en tant qu'Administrateur. Pour compléter votre inscription, utilisez le code de vérification suivant :",
            "instructions": "Cliquez sur le bouton ci-dessous pour activer votre compte et définir votre mot de passe.",
            "button_text": "Activer mon compte",
            "or_copy_text": "Ou copiez et collez ce lien dans votre navigateur :",
            "expiry_label": "Ce code expirera dans :",
        ...
        "en": {
            "subject": "TaxasGE - Administrator Invitation",
            "title": "TaxasGE Administrator Invitation",
            "greeting": "Hello {user_name},",
            "greeting_default": "Hello,",
            "message": "You have been invited to join the TaxasGE platform as an Administrator. To complete your registration, use the following verification code:",
            "instructions": "Click the button below to activate your account and set your password.",
            "button_text": "Activate my account",
            "or_copy_text": "Or copy and paste this link into your browser:",
            "expiry_label": "This code will expire in:",
