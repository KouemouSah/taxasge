...
def register_all_workflows() -> None:
    ...
    v2 (PredefinedWorkflow): Pasaporte, Conducir, Contrato, PromocionAdministrativa, CarnetFuncionario
    v1 (BaseWorkflow): Residencia, Vehiculo, FuncionPublica (3 workflows)
    """
