                        ...
                        <div className="p-6 space-y-4">
                          ...
                          <div className="pt-4 border-t space-y-3">
                            {service.calculation_method ? (
                              /* Formula-based service */
                              <div className="space-y-3">
                                <div className="bg-muted/50 p-3 rounded-md">
                                  <p className="text-xs text-muted-foreground mb-1">Método de cálculo</p>
                                  <p className="text-sm font-medium">Fórmula de cálculo</p>
                                  <p className="text-xs text-muted-foreground mt-1">{service.calculation_method}</p>
                                </div>
                                <Button
                                  variant="default"
                                  size="sm"
                                  ...
                                  onClick={(e) => {
                                    e.stopPropagation()
                                    router.push(`/calculator?service=${service.id}`)
                                  }}
                                >
                                  Calculer
                      ...
                      >
                        <div className="p-6">
                          <div className="grid grid-cols-1 md:grid-cols-[1fr_auto] gap-6">
                            ...
                            {/* Pricing / Formula Section - Fixed width and alignment */}
                              ...
                              {service.calculation_method ? (
                                ...
                                <>
                                  <div className="bg-muted/50 p-3 rounded-md">
                                    ...
                                    <p className="text-xs text-muted-foreground line-clamp-2">{service.calculation_method}</p>
                                  </div>
                                  <Button
                                    variant="default"
                                    size="sm"
