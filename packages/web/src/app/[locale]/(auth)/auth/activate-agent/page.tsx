...
/**
 * Agent Account Activation Page
 * Allows invited agents to set their password and activate their account
 *
 * Flow:
 * 1. Agent receives email with activation link containing email and code
 * 2. Agent clicks link, lands here with pre-filled email/code
 * 3. Agent sets their password
 * 4. Account is created and agent can login
 *
...
import { Loader2, CheckCircle, UserCheck, Eye, EyeOff } from "lucide-react"
...
function ActivateAgentContent() {
  ...
  const handleActivate = async (e: React.FormEvent) => {
    ...
    try {
      const response = await agentCreationApi.activateAgent({
        email,
      ...
      toast({
        title: "Compte active!",
        description: response.message || "Votre compte agent a ete active avec succes.",
      })
        ...
        <main className="flex-1 container mx-auto px-4 py-12">
          <div className="max-w-md mx-auto text-center">
            ...
            <p className="text-muted-foreground mb-4">
              Votre compte agent a ete active avec succes. Vous allez etre redirige vers la page de connexion...
            </p>
      ...
      <main className="flex-1 container mx-auto px-4 py-12">
        <div className="max-w-md mx-auto">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold mb-2">Activer votre compte Agent</h1>
