/**
 * Dynamic Workflow Action Page - CNEDOGE Pasaporte
...
export default function WorkflowActionPage() {
  ...
  const {
    ...
    solicitudType: solicitudType !== 'all' ? (solicitudType as 'expedicion' | 'renovacion') : undefined,
    motivo: motivo !== 'all' ? (motivo as 'vencimiento' | 'perdida' | 'robo' | 'deterioro') : undefined,
  ...
  // Get type label
  const getTypeLabel = (solicitudType: string, motivoValue: string | null) => {
    if (solicitudType === 'expedicion') {
      return 'Nuevo';
    }
    if (solicitudType === 'renovacion' && motivoValue) {
      ...
      return motivoLabels[motivoValue.toUpperCase()] || 'Renovacion';
    }
                ...
                <TableBody>
                  {requests.map((request) => (
                    ...
                    >
                      ...
                      <TableCell>
                        {getTypeLabel(request.solicitudType, request.motivo)}
                      </TableCell>
                      <TableCell>
