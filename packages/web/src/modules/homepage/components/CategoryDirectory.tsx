...
export const CategoryDirectory = () => {
  ...
  const { directory, loading, error } = useCategoryDirectory('es');
      ...
      <div className="container mx-auto px-4">
        ...
        {error && !loading && (
          <Alert variant="destructive" className="mb-6">
            ...
            <AlertDescription>Impossible de charger l&apos;annuaire: {error}</AlertDescription>
          </Alert>
        )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {topCategories.map((category) => (
              <Card
                ...
                onClick={() => router.push(`/search?category=${category.category_code}`)}
              >
