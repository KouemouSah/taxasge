...
/**
 * ArtifactRenderers — Typed artifact display components for Treasury Analyst.
 *
 * Renders structured data from SQL tool results as KPI grids, tables, and summaries.
 * These are deterministic (built from SQL data, not LLM output).
 */
