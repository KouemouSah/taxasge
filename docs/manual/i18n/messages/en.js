...
window.__I18N__.en = {
  ...
  // ---- pages 11-17 (Phase 3 user account, minimal translation) ----
  "page11": {
    "html_title": "Create account — Facil Manual",
    "title": "Create your Facil account",
    "description": "To carry out administrative procedures on Facil, you need a personal account. Creation is free, online, and takes 3-5 minutes.",
  ...
  "page12": {
    ...
    "description": "Access your personal account with your email and password. If you have 2FA enabled, you'll also enter a TOTP code. The mobile app additionally offers biometric login.",
    "prev": "← Previous: Create account",
    "next": "Next: Forgot password →"
  },
  "page13": {
    "html_title": "Forgot password — Facil Manual",
    "title": "Recover your password",
    "description": "If you forgot your password, you don't need to create a new account. The recovery procedure restores your access in less than 5 minutes via a secure link sent to your email.",
    "prev": "← Previous: Sign in",
    "next": "Next: Two-factor authentication →"
  },
  "page14": {
    "html_title": "Two-factor authentication — Facil Manual",
    "title": "Two-factor authentication (2FA)",
    "description": "TOTP-based two-factor authentication (2FA) is the strongest protection against account theft. Enabling it adds a 6-digit code generated by an authenticator app to every login.",
    "prev": "← Previous: Forgot password",
    "next": "Next: Your profile →"
  },
  "page15": {
    "html_title": "Your profile — Facil Manual",
    "title": "Your personal profile",
    "description": "The profile gathers all your personal data on Facil, organized in 4 tabs: personal information, account information, notification preferences, and civil servant verification (if applicable).",
    "prev": "← Previous: Two-factor authentication",
    "next": "Next: Security →"
  },
  "page16": {
    "html_title": "Security — Facil Manual",
    "title": "Configure your account security",
    "description": "The Security page groups all options that protect your account: password, 2FA, active sessions, GDPR export. The mobile version also includes biometrics and local app lock.",
